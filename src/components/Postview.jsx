export const Postview = () => {
  return (
    <div className="flex flex-col gap-8 justify-center px-[700px] py-[100px]">
      ...
      <div>
        <div className="font-bold">Research Your Destination</div>
        <div>
      ...
      <div>
        <div className="font-bold">Plan Your Itinerary</div>
        <div>
